...
import TheNexusImg from "../assets/Nexus.png"
import { FaReact, FaNodeJs, FaHtml5, FaCss3Alt, FaGithub, FaGitAlt } from "react-icons/fa";
import { SiMongodb, SiTailwindcss, SiJavascript, SiRedux, SiGraphql } from "react-icons/si";
...
const Works = [
    ...
    img: TheNexusImg,
    title: "The Nexus",
    description: "A full-stack web platform built to connect and manage resources efficiently, enabling users to collaborate, share information, and access services seamlessly. Focused on creating a responsive and scalable solution tailored for modern web needs.",
    techStack: "React Js | Node Js | Express Js | Mongo DB | GraphQL" ,
    isAvailalbeLink: false,
    appLink: ""
},
...
// ]
const Skills = [
  { name: "React Js", icon: FaReact, color: "#61DAFB" },   // React Blue
  { name: "Node Js", icon: FaNodeJs, color: "#3C873A" },   // Node Green
  { name: "GraphQL", icon: SiGraphql, color: "#E535AB" },  // GraphQL Pink
  { name: "Mongo DB", icon: SiMongodb, color: "#47A248" }, // Mongo Green
  ...
  { name: "Git", icon: FaGitAlt, color: "#F1502F" },       // Git Orange-Red
  { name: "GitHub", icon: FaGithub, color: "#181717" },    // GitHub Black
  { name: "Redux", icon: SiRedux, color: "#764ABC" },      // Redux Purple
];
