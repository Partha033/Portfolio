...
import profilePic from "../../assets/profile_image-modified.png";
    ...
    <>
      <header className="w-full bg-white font-figtree">
        <div className="container mx-auto px-1 md:px-0 lg:px-32 py-4 flex justify-between items-center">
          {/* Logo */}
          <div className="text-4xl md:text-4xl  font-bold text-[#04263e] tracking-tight">Parthiban</div>
          ...
          <nav className="hidden md:flex space-x-6 lg:space-x-8 text-base font-medium ">
            ...
            <a onClick={()=>scrollToWorks("about-section")} className="text-gray-900 hover:text-[#0370DD] hover:underline cursor-pointer">About</a>
            <a onClick={()=>scrollToWorks("skills-section")} className="text-gray-900 hover:text-[#0370DD] hover:underline cursor-pointer">Skills</a>
            <a onClick={()=>scrollToWorks("works-section")} className="text-gray-900 hover:text-[#0370DD] hover:underline cursor-pointer">Projects</a>
            <a onClick={()=>scrollToWorks("contact-section")} className="text-gray-900 hover:text-[#0370DD] hover:underline cursor-pointer">Contact</a>
            <a href="https://drive.google.com/drive/folders/1xx7Smi4e3V2bui9M7BiSHnrNAVs18fgT?usp=sharing" target="_blank" className="text-gray-900 hover:text-[#0370DD] cursor-pointer">Resume</a>
          </nav>
      ...
      <div className="container mx-auto px-1 md:px-0 lg:px-32 flex flex-col  text-center md:text-left md:items-start ">
        <img src={profilePic} className="rounded-full w-32 md:w-[20%] lg:w-28 h-auto" alt="Partha Profile" />
      ...
      <div className="container mx-auto px-1 md:px-0 lg:px-32 mt-4  md:text-left ">
        <p className="text-sm md:text-base text-gray-500 font-medium">
         I am Partha, a MERN Stack Developer with 6 months of professional experience in designing and developing responsive, user-focused, and scalable web applications.
        </p>
        <p className="text-sm md:text-base text-gray-500 font-medium">
          I strongly believe in continuous learning, as technology evolves rapidly and staying updated is essential to growth.
        </p>
        <p className="text-sm md:text-base text-gray-500 font-medium">
           My focus is on adapting to new challenges, enhancing my technical expertise, and delivering impactful digital solutions.
        </p>
      </div>
      ...
      <div className="flex justify-end md:justify-end items-center gap-4">
        <a href="https://www.linkedin.com/in/partha0802/" target="_blank" rel="noopener noreferrer">
          <FaLinkedin className="hover:text-[#0370DD] text-md lg:text-lg" />
        </a>
        <a href="https://github.com/Partha033" target="_blank" rel="noopener noreferrer">
          <FaGithub className="hover:text-[#0370DD] text-md lg:text-lg" />
        </a>
        <a href="mailto:parthibanalaraj@gmail.com" target="_blank" rel="noopener noreferrer">
