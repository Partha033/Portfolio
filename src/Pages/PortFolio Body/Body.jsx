   ...
   <div id="works-section" className="mb-2 font-bold text-3xl md:text-5xl lg:text-5xl text-[#04263e]">Projects</div>
    ...
    <div className="mt-4 ml-4">
      ...
      <div className="text-gray-500 text-sm md:text-base lg:text-base lg:w-[60%] mt-[0.8%]">
        With <span className="font-semibold text-gray-700">6 months of experience</span> as a MERN Stack Developer, I have contributed to various projects, 
        continuously <span className="font-semibold text-gray-700">improving my skills</span> in web application development, exploring new 
        technologies, and applying design patterns to build efficient solutions.
      </div>
    </div>
